    ...
    <div className="container-fluid min-vh-screen d-flex align-items-center justify-content-center bg-light px-3">
      <div className="card w-100 p-4 p-sm-5 border-0 rounded-4 shadow-lg" style={{ maxWidth: "440px", backgroundColor: "#ffffff" }}>
        ...
        <div className="text-center mb-4">
          <div 
            className="mx-auto rounded-3 d-flex align-items-center justify-content-center text-white font-weight-bold fs-2 shadow-sm mb-3" 
            style={{ width: "48px", height: "48px", backgroundColor: "#4f46e5", display: "flex", margin: "0 auto" }}
          >
            F
          </div>
          ...
          <p className="text-muted small">
            ...
            <Link href="/auth/login" className="fw-semibold text-decoration-none" style={{ color: "#4f46e5" }}>
              Sign in
            </Link>
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-check d-flex align-items-center small mb-4 m-0">
            ...
            <label htmlFor="terms" className="form-check-label text-muted ms-2 user-select-none" style={{ cursor: "pointer" }}>
              I agree to the <a href="#" className="text-decoration-none" style={{ color: "#4f46e5" }}>Terms & Conditions</a>
            </label>
          </div>
